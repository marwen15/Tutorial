...
<div class="container">
		<div class="content">
			<a href="single.html"><img src="<?php bloginfo('template_directory'); ?>/images/img2.jpg" class="img-responsive" alt="" /></a>
			<i class="aeroplane"> </i>
...
<h1></h1>
	...
	<div class="lequotes">
			...
			<div class="col-md-12 lequotes3 ">
				<div class="lequotes1">
					<img src="<?php bloginfo('template_directory'); ?>/images/01.png" class="img-responsive" alt="" />
				</div>
				<div class="lequotes2">
					<h3>Le Quotes</h3>
				</div>
